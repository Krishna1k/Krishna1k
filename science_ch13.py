...
Outputs:
  - Science_Class10_Ch13_Our_Environment.pdf  (colour PDF)
  - Science_Class10_Ch13_Our_Environment.md   (markdown, red/green via emoji)
...
CONTENT = r"""OUR ENVIRONMENT
NCERT Class 10 Science - Chapter 13 (Hinglish Detailed Notes)
=========================================================
...
@@    - CONSUMER = doosron ko kha ke energy le (jaanwar, insaan).
...
@@    - OZONE (O3) = upar wali atmosphere me ek gas jo Sun ki harmful kirno
...
=========================================================
$$ DEFINITION: Ek area ke saare jeev (biotic) aur unke aas-paas ki non-living
$$ cheezein (abiotic) milke, ek doosre se interact karte hue jo unit banate
$$ usko ECOSYSTEM kehte hain. (e.g. talaab, jungle, khet.)
...
$$    e.g. AQUARIUM (machhli ghar), GARDEN (bagicha), CROP FIELD (khet).
   @@ Natural ecosystem khud-ba-khud balance rehta; artificial ko insaan
   @@ ko maintain karna padta (paani badalna, khaad daalna, etc.).
...
$$ - Sun ki light + CO2 + paani -> glucose (food) + O2.
...
---------------------------------------------------------
$$ - BACTERIA aur FUNGI (kavak). Ye mre hue jeev / waste / patton ko GALA ke
$$   chhote-chhote simple padaarth me tod dete (decompose).
...
$$   (iii) Inhi recycled nutrients ko plants dobara use karte. Cycle chalta rehta.
   @@ Agar decomposers na ho to: mra hua organic matter padaa rahega, mitti me
   @@ nutrient wapas nahi aayenge, aur poora nutrient cycle ruk jaayega.

<<<PAGEBREAK>>>

3. FOOD CHAIN aur FOOD WEB
=========================================================
$$ FOOD CHAIN (aahar shrinkhala) DEFINITION: jeevo ki ek series jisme har jeev
$$ apne se pehle wale ko khaata - is tarah energy ek se doosre me transfer hoti.

$$ EXAMPLE (yaad rakho):  GHAAS -> HIRAN -> SHER
$$    (grass -> deer -> lion). Teer (->) ka matlab "energy isko jaati / yeh
$$    usko khaata". Ghaas se energy hiran me, hiran se sher me.
...
---------------------------------------------------------
$$ - Asli zindagi me ek jeev sirf ek hi cheez nahi khata. Bahut saari food chains
$$   aapas me jud jaati - inke is interconnected jaal ko FOOD WEB kehte.
   @@ Food web = "bahut saari food chains ka net". Isse ecosystem stable rehta -
   @@ agar ek khana khatam ho to jeev doosra option khaa lete.
...
$$ - Energy ka flow UNIDIRECTIONAL hota = sirf EK hi direction me jaata
$$   (producer -> herbivore -> carnivore). Wapas niche nahi aata.

$$ 10% LAW (Lindeman ka niyam) - bahut important:
$$   - Jab energy ek trophic level se AGLE level me jaati, to sirf lagbhag
$$     10% energy hi transfer hoti hai. Baaki ~90% LOST ho jaati -
$$     heat ke roop me + saans/movement/life processes me kharch ho ke.
...
$$   - Har step par 90% energy gum ho jaati. 4-5 level ke baad itni kam energy
$$     bachti ki ek aur jeev ko palna mushkil. Isliye chains chhoti (3-4 levels).

<<<PAGEBREAK>>>

5. BIOLOGICAL MAGNIFICATION (BIOMAGNIFICATION)
=========================================================
$$ DEFINITION: Kuch harmful chemicals (jaise PESTICIDES / keetnashak - DDT)
$$ jo gal nahi paate, wo food chain me upar jaane par concentration me
$$ BADHTE jaate hain. Isi ko BIOLOGICAL MAGNIFICATION kehte.

$$ KAISE HOTA HAI:
$$   - Khet me chhidke pesticides paani/mitti se plants me aate.
$$   - Plant ko herbivore khaata - chemical uske body me jama.
$$   - Us herbivore ko carnivore khaata - aur zyada jama. Aise har level par
$$     concentration badhti jaati (kyunki chemical body se nikalta nahi).

$$ HUMANS SABSE ZYADA AFFECTED KYUN:
$$   - Insaan aksar food chain ke TOP par hota (top consumer), isliye sabse
$$     zyada concentration insaan ke body me pahunchta - sabse zyada nuksaan.
...
=========================================================
$$ - OZONE (O3) = oxygen ke 3 atom wali gas. Ye atmosphere ki UPAR wali parat
$$   (stratosphere) me hoti hai.
$$ - KAAM: Sun ki harmful ULTRAVIOLET (UV) kirno ko Earth tak aane se ROKTI -
$$   ek protective shield/chhatri ki tarah. Jeev-jantu ko UV se bachati.

$$ OZONE DEPLETION (parat ka patla hona):
$$   - Kuch man-made chemicals, khaaskar CFC (Chloro Fluoro Carbons), ozone ko
$$     tod dete. CFC aate hain - FRIDGE, AC (refrigerators), aur SPRAY/aerosol se.
$$   - Inse ozone layer patli ho jaati (Antarctica ke upar "ozone hole" mila).

$$ EFFECTS (UV zyada aane se nuksaan):
$$   - Insaano me SKIN CANCER (twacha ka cancer), aankh ki bimari (cataract / EYE
$$     DAMAGE), immunity kamzor. Plants aur jal-jeevo ko bhi nuksaan.

$$ MONTREAL PROTOCOL (1987):
$$   - Duniya ke deshon ka agreement - CFC ka utpadan/use KAM karne ke liye,
$$     taaki ozone layer ki raksha ho.
...
$$ - Examples: bacha hua khana, sabzi-chilke, KAAGAZ (paper), COTTON (kapda),
$$   pedo ke patte, gobar (dung), lakdi.
...
$$ - Problems: mitti/paani ki ganndagi (pollution), drains/nala block, jaanwar
$$   plastic kha ke marte, aur biomagnification (DDT jaise chemicals).
...
$$   - COMPOSTING: biodegradable waste se khaad (compost) banao - mitti ko faayda.
   @@ Sahi waste management se pollution kam hota, resources bachte aur
   @@ environment saaf-suthra rehta. (Reduce, Reuse, Recycle yaad rakho.)
...
EXAMPLE 2: Biomagnification kya hai aur insaan sabse zyada kyun affected hote?
   Biomagnification = harmful chemicals (DDT/pesticides) ka food chain me upar
   jaane par concentration badhna (kyunki ye gal/nikal nahi paate). Insaan aksar
   food chain ke TOP par hai (top consumer), isliye sabse zyada chemical insaan
   ke body me jama hota -> sabse zyada nuksaan.

EXAMPLE 3: Food chain me sirf 3-4 trophic level kyun hote? (energy ke aadhar par)
   Kyunki har trophic level par sirf ~10% energy hi aage jaati, ~90% heat aur
   life processes me lost. 4-5 step ke baad itni kam energy bachti ki aur jeev
   ko sustain karna sambhav nahi. Isliye chains chhoti rehti.

EXAMPLE 4: In items ko biodegradable / non-biodegradable me baanto aur 1 problem
   batao: (kaagaz, plastic bag, sabzi ke chilke, kaanch ki botal, gobar).
   ...
   Problem: non-bio waste saalon padaa rehta -> pollution, drains block, jaanwar
   ko nuksaan. Bio waste zyada ho to badboo aur ganndagi.

EXAMPLE 5: Ozone depletion ka KAARAN aur ASAR (effect) batao.
   Kaaran: CFC (Chloro Fluoro Carbons) jo fridge, AC, sprays se nikalte - ozone
   ko todte -> layer patli (ozone hole). Asar: zyada UV Earth par aata ->
   skin cancer, eye damage (cataract), immunity kamzor, fasal/jal-jeev ko nuksaan.
   (Bachav: Montreal Protocol se CFC kam karna.)

EXAMPLE 6: Decomposers ka role kya hai? Agar ye gayab ho jaayein to kya hoga?
   Role: dead matter/waste ko galaa ke environment saaf rakhte aur nutrients
   mitti me wapas lautate (recycling). Agar gayab ho jaayein: mri hui cheezein
   jam jaati, nutrients recycle nahi hote, mitti banjar, aur poora nutrient
   cycle ruk jaata.

EXAMPLE 7 (Easiest): Is food chain me trophic levels pehchaano -
   GHAAS -> TIDDA (grasshopper) -> MENDHAK (frog) -> SAANP (snake).
   Answer: Ghaas = T1 (producer), Tidda = T2 (herbivore/primary consumer),
   Mendhak = T3 (secondary consumer), Saanp = T4 (tertiary consumer).
...
A1. Biotic (saare living - plant, animal, decomposer) aur Abiotic (non-living -
    temperature, paani, mitti, light, hawa).

Q2. Producer, consumer aur decomposer me 1-1 line farak?
A2. Producer = khud khana banaye (green plant). Consumer = doosron ko khaaye
    (animal). Decomposer = dead matter ko galaa de (bacteria, fungi).

Q3. Decomposers ka ek bada importance batao.
A3. Dead matter ko todke nutrients ko mitti me wapas lautate (recycling) aur
    environment saaf rakhte.

Q4. Food chain aur food web me farak?
A4. Food chain = ek single line (ghaas->hiran->sher). Food web = bahut saari
    food chains ka aapas me juda hua jaal (network).

Q5. Trophic levels kya hain? T1 aur T2 kaun?
A5. Food chain ke steps. T1 = producers (plants), T2 = herbivores (primary
    consumers).

Q6. 10% law kya kehta hai?
A6. Ek trophic level se agle level me sirf ~10% energy transfer hoti, baaki
    ~90% heat aur life processes me lost ho jaati.

Q7. Energy ka flow unidirectional hai - matlab?
A7. Energy sirf ek hi direction me jaati (producer -> consumer -> top), wapas
    laut nahi sakti.

Q8. Biomagnification ek line me.
A8. Harmful chemicals (DDT) ka food chain me upar jaane par concentration badhna;
    top consumer (insaan) sabse zyada affected.
...
A10. Biodegradable = kaagaz/sabzi-chilka/gobar. Non-biodegradable = plastic/
     kaanch/metal/DDT.
...
$$  - Ozone: O3 -> UV se bachav, CFC se depletion, Montreal Protocol.
...
def main():
    ...
    pdf_path = here / "Science_Class10_Ch13_Our_Environment.pdf"
    md_path = here / "Science_Class10_Ch13_Our_Environment.md"

    pdf_utils.text_to_pdf(
        CONTENT,
        pdf_path,
        title="Our Environment",
        subtitle="NCERT Class 10 Science - Ch 13 | Hinglish Detailed Notes",
    )
